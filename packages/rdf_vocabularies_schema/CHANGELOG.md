...
- All functionality has been moved to [`locorda_rdf_terms_schema`](https://pub.dev/packages/locorda_rdf_terms_schema) as part of the [locorda](https://github.com/locorda) project.
- The repository has moved to [`github.com/locorda/rdf-vocabularies`](https://github.com/locorda/rdf-vocabularies).
- Please migrate to the new package by replacing `rdf_vocabularies_schema` with `locorda_rdf_terms_schema` in your `pubspec.yaml` and updating your imports.
