...
/// Automated release script for rdf_vocabularies
///
...
void main(List<String> args) async {
  ...
  print('rdf_vocabularies release script');
  print('------------------------');
  if (dryRun) {
...
void _printUsage() {
  ...
  print('-------------');
  print('Automates the release process for the rdf_vocabularies package.');
  print('');
  print('Usage:');
...
Future<void> _ensureNoDevVersionStrings(String releaseVersion) async {
  ...
  for (final filePath in filesToCheck) {
    ...
    final wrongPubAddPattern = RegExp(r'dart pub add rdf_vocabularies:[^\s"]+');
